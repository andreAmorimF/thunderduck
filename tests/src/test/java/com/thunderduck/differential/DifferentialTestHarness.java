...
import com.thunderduck.differential.model.Divergence;
import com.thunderduck.differential.validation.DataFrameComparator;
import com.thunderduck.differential.validation.SchemaValidator;
...
/**
 * Abstract base class for differential testing between Spark and thunderduck.
 *
 * <p>This harness provides:
 * <ul>
 *   <li>Spark 3.5.3 local mode session management</li>
 *   <li>DuckDB connection management for thunderduck</li>
...
public abstract class DifferentialTestHarness extends TestBase {
    ...
    /**
     * Execute a query on both Spark and thunderduck, then compare results.
     *
    ...
    /**
     * Execute a query on both Spark and thunderduck by writing/reading Parquet.
     *
     * @param testName descriptive name for this test
