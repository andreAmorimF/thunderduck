...
public class ErrorHandlingTest {
    ...
    class SQLGenerationExceptionTests {
        ...
        void testUnsupportedOperatorThrowsException() {
            // Given: Unsupported LocalRelation plan (not yet implemented)
            LocalRelation localRel = new LocalRelation(
                new StructType(
            ...
            assertThatThrownBy(() -> generator.generate(localRel))
                .isInstanceOf(UnsupportedOperationException.class)
                .hasMessageContaining("LocalRelation");
        }
