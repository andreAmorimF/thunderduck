package com.thunderduck.security;
...
public class SQLInjectionTest {
    ...
    class EndToEndSQLInjectionTests {
        ...
        void testComplexQueryWithMultipleInjectionPoints() {
            ...
            ColumnReference col1 = new ColumnReference("SELECT", com.thunderduck.types.StringType.get());
            String alias1 = "result"; // Safe

            // Column with special characters
            ColumnReference col2 = new ColumnReference("user\"name", com.thunderduck.types.StringType.get());
        ...
        void testFilterWithMaliciousCondition() {
            ...
            ColumnReference nameCol = new ColumnReference("name", com.thunderduck.types.StringType.get());
