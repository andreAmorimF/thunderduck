...
import com.catalyst2sql.exception.ValidationException;
...
import com.catalyst2sql.logical.Union;
...
public class QueryValidator {
    ...
    private static void collectReferencedColumns(Expression expr, Set<String> columns) {
        ...
        if (expr instanceof ColumnReference) {
            ...
            for (com.catalyst2sql.logical.Sort.SortOrder order : window.orderBy()) {
