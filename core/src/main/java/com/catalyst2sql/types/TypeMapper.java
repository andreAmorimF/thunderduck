...
public class TypeMapper {
    ...
    /**
     * Converts a catalyst2sql DataType to a DuckDB SQL type string.
     *
     * <p>Examples:
     * <pre>
     *   IntegerType → "INTEGER"
     ...
     * </pre>
     *
     * @param sparkType the catalyst2sql data type
    ...
    /**
     * Converts a DuckDB SQL type string to a catalyst2sql DataType.
     *
     ...
     * @return the catalyst2sql data type
    ...
    /**
     * Checks if a catalyst2sql DataType is compatible with a DuckDB SQL type string.
     *
     * @param sparkType the catalyst2sql data type
     * @param duckdbType the DuckDB SQL type string
